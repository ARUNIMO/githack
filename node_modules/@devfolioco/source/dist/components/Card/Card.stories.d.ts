...
declare const _default: {
    title: string;
    component: ({ children, title, subtitle, backgroundColor, shadow, ...other }: CardProps & React.HTMLAttributes<HTMLDivElement>) => JSX.Element;
    argTypes: {
        background: {
            control: {
                type: string;
...
export declare const Demo: Story<CardProps>;
